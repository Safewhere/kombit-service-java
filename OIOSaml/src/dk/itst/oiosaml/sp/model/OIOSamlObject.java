 ...
 *
 * This class defines default behavior, such as signature handling and
 * serialization.
 *
...
public class OIOSamlObject {
     ...
     *
     * The effect of calling this method is that a new Signature element is
     * created, and the object is marshalled. If {@link #toXML()} is called, the
     * XML will contain a valid signature.
     *
    ...
    /**
     * Check that a given object has been signed correctly with a specific
     * {@link PublicKey}.
     *
     * @return true, if the signableObject has been signed correctly with the
     * given key. Returns <code>false</code> if the object is not signed at all.
     */
