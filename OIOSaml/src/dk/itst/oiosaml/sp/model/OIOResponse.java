...
public class OIOResponse extends OIOAbstractResponse {
     ...
     *
     * @param handler Handler which holds sent request ids. This is used if the
     * response has a InResponseTo.
     *
     * @throws ValidationException If the response is unsolicited and does not
     * contain an issuer.
     */
