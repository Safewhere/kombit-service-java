...
public class OIOAbstractResponse extends OIOSamlObject {
     ...
     * @return <code>true</code>, if the destination is match the destination in
     * the &lt;SAMLResponse&gt; - otherwise <code>false</code>. If the response
     * does not have a destination, <code>true</code> is returned.
     */
