...
public interface Constants {
    ...
    /**
     * Session attribute for holding the user's current assertion. The value of
     * the attribute should be a {@link UserAssertion}.
     */
    ...
    /**
     * Property for setting the username used for the anonymous user. The
     * anonymous user is used when IsPassive is true, and the user is not signed
     * in at the IdP.
     */
    static final String PROP_PASSIVE_USER_ID = "oiosaml-sp.passive.user";

    /**
     * A comma separated list of urls for which ForceAuthn should be set to
     * true. Each url is treated as a regular expression against the request
     * (without the servlet path).
     */
    ...
    /**
     * Configuration parameter containing the default IdP entity id if no
     * _saml_idp cookie was set.
     */
    static final String PROP_DISCOVERY_DEFAULT_IDP = "oiosaml-sp.discovery.default";

    /**
     * Configuration parameter enabling IdP prompting if no IdP was discovered.
     * Cannot be used in conjunction with {@link #PROP_DISCOVERY_DEFAULT_IDP}.
     */
    ...
    /**
     * Property controlling if the service will show errormessages/stacktraces
     * to the user NOTE! Should always be false in production, to void security
     * issues with XML Encryption
     */
