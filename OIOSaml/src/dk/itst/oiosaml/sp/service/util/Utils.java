...
//        String data = queryString.substring(queryString.indexOf(firstQueryParameter), queryString.lastIndexOf("&"));
     ...
     *
     * @param data The query parameters in the HTTP Redirect, which has been
     * signed
     * @param key The public key of the certificate from the expected sender
     * @param sig The signature generated by the sender after it has been base64
     * decoded
...
//		result = result.trim();
     ...
     * @return The SOAP version, represented by the SOAP namespace. Returns
     * <code>null</code> if no namespace was found.
     */
