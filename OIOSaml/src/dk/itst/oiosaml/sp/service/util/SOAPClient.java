...
public interface SOAPClient {
     ...
     * @param ignoreCertPath Set to <code>true</code> to ignore certificate path
     * errors on ssl connections.
     * @param xml Complete SOAP Envelope as string.
     * @param soapAction SOAP Action to invoke.
     * @return The response envelope if the server returned 200 OK. An exeption
     * is thrown in all other cases.
     * @throws IOException If a generic IO exception occurred, for example if
     * the connection failed.
     * @throws SOAPException If the server returned anything but 200 OK.
     */
    public Envelope wsCall(String location, boolean ignoreCertPath, String xml, String soapAction) throws IOException, SOAPException;
}
