 ...
 *
 * Use {@link #get()} to retrieve the assertion from the application layer if
 * there is no access to the session.
 *
 * @author recht
 *
 */
public final class UserAssertionHolder {
    ...
    /**
     * Get the current user assertion. Will return <code>null</code> if the user
