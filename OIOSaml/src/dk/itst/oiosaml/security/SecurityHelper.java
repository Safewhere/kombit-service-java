...
/**
 * Some utility methods for doing security, credential, key and JCE related
 * tests.
 */
public class SecurityHelper {
     ...
     * @throws CertificateException thrown if there is an error constructing
     * certificate
     */
     ...
     *
     * @throws KeyException thrown if the key algorithm is not supported by the
     * JCE or the key spec does not contain valid information
     */
