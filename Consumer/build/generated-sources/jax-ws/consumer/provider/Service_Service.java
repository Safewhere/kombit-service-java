 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://kombit.provider.dk/", wsdlLocation = "https://service.eksterntest-stoettesystemerne.dk:8181/Service/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://kombit.provider.dk/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://service.eksterntest-stoettesystemerne.dk:8181/Service/Service?wsdl");
    ...
    public consumer.provider.Service getServicePort() {
        return super.getPort(new QName("http://kombit.provider.dk/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public consumer.provider.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://kombit.provider.dk/", "ServicePort"), Service.class, features);
    }
